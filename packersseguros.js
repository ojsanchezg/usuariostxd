function procesarLista() {
    ...
    resultadoElement.innerHTML = `mutation securePackersOdeon {`;
    for (let i=0; i < listaCadenasNombre.length; i++) {
        ...
        resultadoElement.innerHTML += `<p>p${i}: associatePermission(user: <b>"${usuarios}"</b>, clientId: "odeon-front", scope: "packer", metadata: "stores::<b>${cadenaTiendaUsuarios}"</b>),</p>`;
    }
