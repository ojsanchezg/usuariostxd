function procesarLista() {
    ...
    resultadoElement.innerHTML = `mutation swissSecurePickers {`;
...
//        resultadoElement.innerHTML += `<pre>  <b>m${i}</b>: associateUserToClient(user: <b>"${usuarios}"</b>, clientId: "app_tienda_mobile"),</pre>`;
        resultadoElement.innerHTML += `<pre>  p${i}: associateUserWithPermissions(user: <b>"${usuarios}"</b>, clientId: "app_tienda_mobile", scope: "odeon-picker", metadata: "stores::<b>${cadenaTiendaUsuarios}"</b>),</pre>`;
    }
