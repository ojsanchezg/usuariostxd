function procesarLista() {
    ...
    resultadoElement.innerHTML = `mutation egVisualicer {<br>`;
    for (let i=0; i < listaCadenasNombre.length; i++) {
        ...
        resultadoElement.innerHTML += `<span>p${i}: associatePermission(user: <b>"${usuarios}"</b>, clientId: "eg_dispatcher_frontend", scope: "visualicer", metadata: "dcs::<b>${cadenaDcsUsuarios}"</b>),</span><br>`;
    }
