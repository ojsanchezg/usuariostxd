function procesarLista() {
    ...
    resultadoElement.innerHTML = `mutation javelSuperuser {<br>`;
    for (let i=0; i < listaCadenasNombre.length; i++) {
        ...
        resultadoElement.innerHTML += `<span>p${i}: associatePermission(user: <b>"${usuarios}"</b>, clientId: "javel_front", scope: "superuser", metadata: "stores::<b>${cadenaTiendaUsuarios}"</b>),</span><br>`;
    }
